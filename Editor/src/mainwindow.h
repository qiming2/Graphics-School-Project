...
public:
    ...
    void NonInteractiveRender(QString filename1, QString filename2) {

        NonInteractiveRenderHelper(filename1, filename2);
    }
...
protected:
    ...
    void NonInteractiveRenderHelper(QString filename1, QString filename2);
